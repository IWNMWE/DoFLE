...
def recieve():
    """Recieves models sent by the clients.

    Recieves a JSON file from the POST requests
    sent by clients and stores the local weights,
    number of datapoints and also get the config
    file of the local models
